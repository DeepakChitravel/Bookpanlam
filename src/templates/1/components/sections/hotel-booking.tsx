    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-cyan-50">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-400 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg className="w-full h-20 text-blue-50" viewBox="0 0 1200 120" preserveAspectRatio="none">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-6xl font-bold text-white mb-4 drop-shadow-lg">Ocean Breeze Restaurant</h1>
            ...
            <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full mb-8 border border-white/30">
              <div className={`h-4 w-4 rounded-full ${isOpen ? 'bg-green-400 animate-pulse' : 'bg-red-400'}`}></div>
            ...
            <p className="text-2xl text-cyan-100 mb-10 font-light">Where Every Meal is a Destination</p>

            {/* Maldives-style search and booking bar */}
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 mb-10 border border-white/30">
              <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
                  <div className="text-left">
                    ...
                    <div className="text-white text-lg font-semibold">Ocean View Dining</div>
                  </div>
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-white text-lg font-semibold">After 2 Hours</div>
                  </div>
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-white text-lg font-semibold">Select Below</div>
                  </div>
                </div>
                ...
                <div className="relative w-full max-w-2xl">
                  <input
                    ...
                    className="w-full px-6 py-4 pl-14 rounded-2xl bg-white/20 backdrop-blur-sm border-2 border-white/30 text-white placeholder-white/70 focus:outline-none focus:border-white/50 focus:ring-4 focus:ring-white/20 transition-all"
                  />
                  <Search className="absolute left-5 top-1/2 transform -translate-y-1/2 h-6 w-6 text-white/70" />
                  <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-2 rounded-xl font-medium hover:from-cyan-600 hover:to-blue-700 transition-all">
                    Explore
                  </button>
                </div>
              </div>
            ...
            {hasRestaurantData && restaurantData.settings && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center bg-white/10 backdrop-blur-sm p-5 rounded-2xl border border-white/20">
                  <div className="flex items-center justify-center gap-3 text-white mb-3">
                    <Clock className="h-6 w-6" />
                    <span className="font-semibold text-lg">Sailing Hours</span>
                  </div>
                ...
                <div className="text-center bg-white/10 backdrop-blur-sm p-5 rounded-2xl border border-white/20">
                  <div className="flex items-center justify-center gap-3 text-white mb-3">
                    ...
                    <span className="font-semibold text-lg">Open Days</span>
                  </div>
                  <p className="text-cyan-100 text-base">
                ...
                <div className="text-center bg-white/10 backdrop-blur-sm p-5 rounded-2xl border border-white/20">
                  <div className="flex items-center justify-center gap-3 text-white mb-3">
                    ...
                    <span className="font-semibold text-lg">Docking Capacity</span>
                  </div>
                  <p className="text-cyan-100 text-base">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-4">A Culinary Journey Across The Seven Seas</h2>
              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      flex items-center gap-3 px-6 py-4 rounded-xl transition-all duration-300 whitespace-nowrap border-2
                    ...
                    `}
                  >
                    <Icon className={`h-5 w-5 ${selectedCategory === category.id ? 'text-white' : 'text-blue-600'}`} />
                    <span className="font-medium">{category.name}</span>
                    {selectedCategory === category.id && (
                      <span className="ml-2 text-xs bg-white/30 px-2 py-1 rounded-full">✓</span>
                    )}
                  </button>
                );
              })}
          ...
          <div className="relative">
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="appearance-none bg-white border-2 border-blue-200 rounded-xl px-4 py-3 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-6 rounded-2xl border-2 border-blue-200 shadow-sm">
            <div className="text-4xl font-bold text-blue-600">{items.length}</div>
            <div className="text-sm text-gray-600 mt-2">Total Culinary Destinations</div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-violet-50 p-6 rounded-2xl border-2 border-purple-200 shadow-sm">
            <div className="text-4xl font-bold text-purple-600">{avgEatingTime}</div>
            <div className="text-sm text-gray-600 mt-2">Avg. Journey Time</div>
          ...
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 p-6 rounded-2xl border-2 border-orange-200 shadow-sm">
            <div className="text-4xl font-bold text-orange-600">{totalSeats}</div>
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h3 className="text-3xl font-bold text-gray-900">Most Popular Culinary Destinations</h3>
              <p className="text-gray-600">Something amazing waiting for you</p>
            </div>
            <div className="flex gap-2">
              <span className="text-xs bg-blue-100 text-blue-800 px-3 py-1.5 rounded-full">All Services</span>
              <span className="text-xs bg-cyan-100 text-cyan-800 px-3 py-1.5 rounded-full">Activities</span>
              <span className="text-xs bg-green-100 text-green-800 px-3 py-1.5 rounded-full">Amenities</span>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-white rounded-2xl border-2 border-gray-200">
              ...
              <h3 className="text-2xl font-bold text-gray-700 mb-2">No culinary destinations found</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredItems.map((item) => {
                ...
                return (
                  <div key={item.id} className="group bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-300 hover:shadow-xl transition-all duration-500 overflow-hidden">
                    {/* Image Section */}
                    <div className="relative h-56 overflow-hidden">
                      ...
                      {item.prebooking_enabled && (
                        <div className="absolute top-4 right-4">
                          <span className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg flex items-center gap-1">
                      ...
                      <div className="absolute top-4 left-4 flex gap-2">
                        {item.popular && (
                          <span className="bg-gradient-to-r from-amber-400 to-orange-500 text-white text-xs font-bold px-3 py-1.5 rounded-full flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="absolute top-4 right-16 bg-white/20 backdrop-blur-sm p-2 rounded-full hover:bg-white/30 transition-colors"
                      >
                        <Heart
                      ...
                      {item.preparation_time && (
                        <div className="absolute bottom-4 right-4 bg-black/60 backdrop-blur-sm text-white text-xs font-medium px-3 py-1.5 rounded-full flex items-center gap-1">
                          <Clock className="h-3 w-3" />
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-2xl font-bold text-gray-900">
                            ...
                            <span className="text-sm text-gray-500 ml-2">/journey</span>
                          </div>

                          {/* Prebooking Badge */}
                          {item.prebooking_enabled && (
                            <div className="flex items-center gap-2 mt-2">
                              <div className="text-xs bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-3 py-1 rounded-full font-medium">
                        ...
                        <div className="flex flex-col gap-2">
                          {item.prebooking_enabled ? (
                            <button
                              ...
                              className="group/btn bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 flex items-center gap-2"
                            >
                              <CalendarDays className="h-5 w-5 group-hover/btn:rotate-12 transition-transform" />
                              Book Early
                            </button>
                          ) : (
                            <button
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl border-2 border-blue-200 p-8">
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Dream Your Next Culinary Journey</h3>
                  ...
                  <button className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-6 py-3 rounded-xl font-medium hover:from-blue-700 hover:to-cyan-600 transition-all flex items-center gap-2">
                    <Compass className="h-5 w-5" />
                ...
                <div className="bg-white p-6 rounded-2xl border border-blue-100">
                  <div className="text-center">
                    <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-800 px-4 py-2 rounded-full mb-4">
                      ...
                      <span className="font-semibold">Best Culinary Agency</span>
                    </div>
                    <p className="text-gray-700 mb-4">We&apos;ve got the perfect dining experiences for you.</p> {/* Fixed apostrophe */}
          ...
          <div className="mt-16 bg-gradient-to-r from-white to-blue-50 rounded-2xl border-2 border-blue-200 p-8">
            <div className="max-w-3xl mx-auto">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Book Your Table Journey</h3>
              ...
              {userLoading ? (
                <div className="mb-6 p-4 bg-gray-100 rounded-xl animate-pulse">
                  <div className="h-4 bg-gray-200 rounded w-1/3 mb-2"></div>
                  <div className="h-6 bg-gray-200 rounded w-2/3"></div>
                </div>
              ) : user ? (
                <div className="mb-6 p-4 bg-gradient-to-r from-green-50 to-emerald-100 border border-green-200 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-green-800">Journey Planner:</p>
                      <p className="text-lg font-bold text-gray-900">{user.name}</p>
                      <p className="text-sm text-gray-600">{user.email}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-sm text-gray-500">Contact: {user.phone}</p>
                      <a
                        href={`/${site}/profile`}
                ...
                <div className="mb-6 p-4 bg-gradient-to-r from-amber-50 to-orange-100 border border-amber-200 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-amber-800">Please login to plan your journey</p>
                      <p className="text-sm text-gray-600">Your details will be auto-filled</p>
                    </div>
                    <a
                      href={`/${site}/login`}
                      className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-4 py-2 rounded-lg hover:from-blue-700 hover:to-cyan-600 transition-all"
                    >
                      Login / Register
                    </a>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      readOnly={!!user}
                      className={`w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all ${user ? 'bg-gray-50 cursor-not-allowed' : ''
                        }`}
                    />
                    {user && (
             ...
             focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {availableTimeSlots.map((slot: any, index) => (
                        <button
                          ...
                          className={`p-3 rounded-xl border-2 transition-all ${reservationForm.time === slot.start
                        ...
                        >
                          <div className="text-center">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              {slot.duration} min • {slot.availableTables.length} docks available
                            </div>
                ...
                {reservationForm.seats && reservationForm.date && availableTimeSlots.length === 0 && (
                  <div className="p-4 bg-amber-50 border-2 border-amber-200 rounded-xl">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="font-medium text-amber-800">No sailing times available</p>
                ...
                {reservationForm.time && (
                  <div className="p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-blue-800">Selected Sailing Time</p>
                ...
                <button
                  ...
                  className={`w-full font-bold py-4 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] ${user && reservationForm.seats && reservationForm.date && reservationForm.time
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl border-2 border-blue-200 p-8">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center md:text-left">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-xl mb-4">
                  <MapPin className="h-6 w-6 text-white" />
                </div>
                <h4 className="font-bold text-gray-900 mb-2">Journey Location</h4>
                <p className="text-gray-600">123 Ocean View Street, Maldives Island</p>
                <p className="text-sm text-gray-500">Contact: +1 234 567 8900</p>
              </div>

              <div className="text-center md:text-left">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-400 rounded-xl mb-4">
                  <DoorOpen className="h-6 w-6 text-white" />
                </div>
                <h4 className="font-bold text-gray-900 mb-2">Visit Us</h4>
                <p className="text-gray-600">Perfect for romantic dinners & celebrations</p>
                <p className="text-sm text-gray-500">Private docking available</p>
              </div>

              <div className="text-center md:text-left">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-amber-500 to-orange-400 rounded-xl mb-4">
                  <Star className="h-6 w-6 text-white" />
                </div>
                <h4 className="font-bold text-gray-900 mb-2">Awards & Recognition</h4>
                <p className="text-gray-600">Best Fine Dining 2023</p>
                <p className="text-sm text-gray-500">Certified by Culinary Excellence</p>
              </div>
            </div>
